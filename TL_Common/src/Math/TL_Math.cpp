...
namespace TL_Math
{
	...
	constexpr Vector2 Vector2::UnitX = { 1.f, 0.f };
	constexpr Vector2 Vector2::UnitY = { 0.f, 1.f };

	constexpr Vector3 Vector3::Zero{ 0, 0, 0 };
	constexpr Vector3 Vector3::One = { 1.f, 1.f, 1.f };
	constexpr Vector3 Vector3::UnitX = { 1.f, 0.f, 0.f };
	constexpr Vector3 Vector3::UnitY = { 0.f, 1.f, 0.f };
	constexpr Vector3 Vector3::UnitZ = { 0.f, 0.f, 1.f };
	constexpr Vector3 Vector3::Up = { 0.f, 1.f, 0.f };
	constexpr Vector3 Vector3::Down = { 0.f, -1.f, 0.f };
	constexpr Vector3 Vector3::Right = { 1.f, 0.f, 0.f };
	constexpr Vector3 Vector3::Left = { -1.f, 0.f, 0.f };
	constexpr Vector3 Vector3::Forward = { 0.f, 0.f, 1.f };
	constexpr Vector3 Vector3::Backward = { 0.f, 0.f, 1.f };

	constexpr Vector4 Vector4::Zero = { 0.f, 0.f, 0.f, 0.f };
	constexpr Vector4 Vector4::One = { 1.f, 1.f, 1.f, 1.f };
	constexpr Vector4 Vector4::UnitX = { 1.f, 0.f, 0.f, 0.f };
	constexpr Vector4 Vector4::UnitY = { 0.f, 1.f, 0.f, 0.f };
	constexpr Vector4 Vector4::UnitZ = { 0.f, 0.f, 1.f, 0.f };
	constexpr Vector4 Vector4::UnitW = { 0.f, 0.f, 0.f, 1.f };

	constexpr Matrix Matrix::Identity = { 1.f, 0.f, 0.f, 0.f,
									  0.f, 1.f, 0.f, 0.f,
									  0.f, 0.f, 1.f, 0.f,
									  0.f, 0.f, 0.f, 1.f };
	constexpr Quaternion Quaternion::Identity{ 0, 0, 0, 1 };
}
