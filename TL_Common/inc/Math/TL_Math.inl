...
inline Vector3 Quaternion::ToEulerDeg() const noexcept
{
    return ToEuler() * RAD_TO_DEG;
}
...
inline Quaternion Quaternion::CreateFromAxisAngleDeg(const Vector3& axis, float angleDeg) noexcept
{
    return CreateFromAxisAngle(axis, angleDeg * DEG_TO_RAD);
}
...
inline Quaternion Quaternion::CreateFromYawPitchRollDeg(float yawDeg, float pitchDeg, float rollDeg) noexcept
{
    return CreateFromYawPitchRoll(yawDeg * DEG_TO_RAD, pitchDeg * DEG_TO_RAD, rollDeg * DEG_TO_RAD);
}
...
inline Quaternion Quaternion::CreateFromYawPitchRollDeg(const Vector3& _euler) noexcept
{
    const Vector3 _angles = _euler * DEG_TO_RAD;
    return CreateFromYawPitchRoll(_angles);
}
